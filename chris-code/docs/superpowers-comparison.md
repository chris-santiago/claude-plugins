...
Every superpowers skill is present in chris-code (two renamed), so chris-code is a true superset.
...
| writing-plans | lean-spec + lean-plan | Heavily rewritten (split) |
